...
<div class="grid grid-cols-4 gap-4">
	...
	<div class="flex flex-row flex-wrap gap-1 items-center justify-self-end col-span-2">
	...
	{#each character.remainingAbilities as ability (ability.id)}
		...
		{#if ability.glimmeredFrom.length}
			<div class="grid grid-cols-subgrid col-start-3 col-span-2 bg-base-300 p-2">
